...
void UKF::Prediction(double delta_t) {
  ...
  double  sqrt_lam_plus_aug = sqrt(lambda_ + n_aug_);
  VectorXd A_aug_and_sqrt;
  for (int i = 0; i < n_aug_; i++)
  {
    A_aug_and_sqrt = A_aug.col(i)*sqrt_lam_plus_aug; 
    Xsig_aug.col(i+1) = x_aug + A_aug_and_sqrt;
    Xsig_aug.col(n_aug_+1+i) = x_aug - A_aug_and_sqrt;
  }
